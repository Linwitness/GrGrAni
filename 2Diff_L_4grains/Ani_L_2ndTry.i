...
[Materials]
  [./L_equation]
    ...
    function = 'num:=(L01*gr1^2*gr0^2 + L02*gr1^2*gr2^2 + L03*gr2^2*gr3^2 + L12*gr3^2*gr0^2 + L13*gr2^2*gr0^2 + L23*gr1^2*gr3^2);
                den:=(gr1^2*gr0^2 + gr1^2*gr2^2 + gr2^2*gr3^2 + gr3^2*gr0^2 + gr2^2*gr0^2 + gr1^2*gr3^2);
                if(den != 0, num/den, if(gr1=0&gr2=0&gr3=0, (L01 + L02 + L03)/3,
                                                  if(gr0=0&gr2=0&gr3=0, (L01 + L12 + L13)/3,
                                                              if(gr0=0&gr1=0&gr3=0, (L02 + L12 + L23)/3,
                                                                          if(gr0=0&gr1=0&gr2=0, (L03 + L13 + L23)/3,
                                                                                                43
                                                                                                )
                                                                )
                                                    )
    ...
    constant_expressions = '39.0 30.0 41.0 36.5 35.0 37.5 0.01'
    outputs = exodus
    output_properties = 'L'
  [../]
